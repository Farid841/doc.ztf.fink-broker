...
Note there has been a change of syntax recently ([2024-11-25-cutout-handling](https://doc.ztf.fink-broker.org/en/latest/troubleshooting/#2024-11-25-api-cutout-handling)). You can also request the 3 cutouts in one call now by specifying `kind=All`:
